  ...
  public: {
    Tables: {
      certificate_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "certificate_templates_ngo_id_fkey"
            columns: ["ngo_id"]
            isOneToOne: false
      ...
      event_registrations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_event_registrations_events"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
      ...
      events: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_events_ngo_profiles"
            columns: ["ngo_id"]
            isOneToOne: false
            referencedRelation: "ngo_profiles"
            referencedColumns: ["id"]
      ...
      ngo_enrollments: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_ngo_enrollments_ngo_profiles"
            columns: ["ngo_id"]
            isOneToOne: false
            referencedRelation: "ngo_profiles"
            referencedColumns: ["id"]
